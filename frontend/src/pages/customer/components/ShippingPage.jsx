    ...
    <React.Fragment>
      {
        shippingData && Object.keys(shippingData).length > 0 ? 
          ...
          <Typography variant="h6">
            <strong>State:</strong>
            <span style={{ fontSize: '16px', marginLeft: '10px' }}>
              {shippingData && shippingData.state}
            </span>
          </Typography>
          <Typography variant="h6">
          ...
          <Typography variant="h6">
            ...
            <span style={{ fontSize: '16px', marginLeft: '10px' }}>
              {shippingData && shippingData.pinCode}
            </span>
          </Typography>
          <Typography variant="h6">
            <strong>Phone Number:</strong>
            <span style={{ fontSize: '16px', marginLeft: '10px' }}>
              {shippingData && shippingData.phoneNo}
            </span>
          </Typography>
            ...
            <Collapse in={showTab} timeout="auto" unmountOnExit>
                <Box
                  sx={{
                    ...
                    background: '#f5f5f5', // Background color when expanded
                    border: '2px solid #0066cc', // Border styles
                    borderRadius: '15px', // Border radius
                    overflow: 'hidden', // Overflow styles
          ...
          <React.Fragment>
            ...
            <Box className="form-buttons" sx={{ display: 'flex', justifyContent: 'flex-end' }}>
              {profile ?
                <Button
